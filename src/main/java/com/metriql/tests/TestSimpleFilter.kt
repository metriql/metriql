...
abstract class TestSimpleFilter<C> {
    ...
    fun testStringFiltersNotEquals() {
        ...
        val filter =
            """{"and":  [
                |{"dimension": "test_string", "operator": "not_equals", "value": "alpha"}, 
                |{"dimension": "test_string", "operator": "equals", "value": "bravo"}
                |]}""".trimMargin()
    ...
    fun testNumberFiltersGreaterThanAndLessThanInt() {
        @Language("JSON5")
        val filter = """{"and": [{"dimension": "test_int", "operator": "greater_than", "value": 3}, 
            |{"dimension": "test_int", "operator": "less_than", "value": 5}]}""".trimMargin()
    ...
    fun testNumberFiltersGreaterThanAndLessThanDouble() {
        @Language("JSON5")
        val filter = """{"and": [{"dimension": "test_double", "operator": "greater_than", "value": 3}, 
            |{"dimension": "test_double", "operator": "less_than", "value": 5}]}""".trimMargin()
        check(castToDouble("test_double"), filter, listOf(4.0))
    }
    ...
    fun testTimestampGreaterThan() {
        @Language("JSON5")
        val filter = """{"dimension": "test_timestamp", "operator": "greater_than", 
            |"value": ${SampleDataset.testTimestamp.last().format(DateTimeFormatter.ISO_DATE_TIME)}}""".trimMargin()
    ...
    fun testTimestampGreaterThanAndLessThan() {
        @Language("JSON5")
        val filter =
            """{"and": [{"dimension": "test_timestamp", "operator": "greater_than", "value": ${SampleDataset.testTimestamp[3]}},
                | {"dimension": "test_timestamp", "operator": "less_than", "value": ${SampleDataset.testTimestamp[5]}}]}""".trimMargin()
    ...
    fun testDateGreaterThanAndLessThan() {
        @Language("JSON5")
        val filter =
            """{"and": [{"dimension": "test_date", "operator": "greater_than", "value": ${SampleDataset.testDate[3]}}, 
                |{"dimension": "test_date", "operator": "less_than", "value": ${SampleDataset.testDate[5]}}]}""".trimMargin()
