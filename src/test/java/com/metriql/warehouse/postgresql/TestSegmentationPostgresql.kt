                ...
                if (it == "_table2") {
                    ...
                    statement =
                        connection.prepareStatement(
                            "INSERT INTO ${testingServer.bridge.quoteIdentifier(it)} " +
                    ...
                    statement =
                        connection.prepareStatement(
                            "INSERT INTO ${testingServer.bridge.quoteIdentifier(it)} (teststr, testnumber, testbool, testmap, testarray, testdate, _time) " +
                                "VALUES (?, ?, ?, ?, ?, ?, ?)"
                        )
                }
