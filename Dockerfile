...
RUN export MAVEN_OPTS="-Xmx1524M -Xss128M -XX:MetaspaceSize=512M -XX:MaxMetaspaceSize=1024M -XX:+CMSClassUnloadingEnabled -XX:+UseConcMarkSweepGC" && ./mvnw package -Dmaven.test.skip=true
