...
RUN apt-get update && apt-get install python-dev python3-pip google-cloud-sdk -y && pip3 install "pip>=20" && pip3 install metriql-lookml==0.2 metriql-tableau==0.4 metriql-superset==0.6 metriql-metabase==0.5
